...
exports.createDraftDoiSecondGen = onCall(async (data) => {
...
// are pulled from the admin section of the firebase db
exports.updateDraftDoiSecondGen = onCall(async (dataObj) => {
...
// are pulled from the admin section of the firebase db
exports.deleteDraftDoiSecondGen = onCall(async (data) => {
...
exports.getDoiStatusSecondGen = onCall(async (data) => {
...
exports.getDoiSecondGen = onCall(async (data) => {
...
exports.getCredentialsStoredSecondGen = onCall(async (data) => {
  try {
...
exports.getDatacitePrefixSecondGen = onCall(async (region) => {
  try {
